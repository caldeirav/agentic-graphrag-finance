...
- **FR-011**: Export MUST produce **paper-ready tables**: overall headline (all manifest variants), by inspiration_profile stratum, variant delta (graph-full minus flat-chunk plus ablation deltas vs graph-full), and trajectory audit summary—in machine-readable and human-readable formats.
